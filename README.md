...
- [`NTP_GC9A01_Clock/`](NTP_GC9A01_Clock/NTP_GC9A01_Clock.ino) — for an ESP32-C3 SuperMini. Connects to WiFi, syncs the time from an NTP server, and displays the current time and date on a round GC9A01 SPI TFT display. Requires the "Adafruit GC9A01A", "Adafruit GFX Library", and "Adafruit BusIO" libraries from the Library Manager. Edit the WiFi credentials, time zone offsets, and display pin definitions at the top of the sketch before uploading.
